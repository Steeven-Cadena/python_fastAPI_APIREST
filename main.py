...
# CRUD Read (lectura) GET ALL: Leeremos todos los cursos de hayan en la db
...
# CRUD: Update (Actualizar) PUT: Modificaremos un recurso que coincida con el ID que mandemos
...
# CRUD: Delete (Borrar) DELETE: Eliminaremos el recurso que coincida con el ID que mandemos
